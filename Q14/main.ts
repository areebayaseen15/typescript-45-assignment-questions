// Qno14 :Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? 
...
guests.forEach(guest => {
    console.log(`Dear ${guest}, You are invited to dinner on Sunday.`)
})
